...
export default function Home() {
  ...
  if (isPending) {
    // Render dashboard eagerly so its /dashboard fetch fires in parallel
    // with the session check. If the user is not logged in, the fetch
    // will 401 harmlessly and we'll swap to the landing page once
